...
vector<int> nodes_covered;nodes_covered.push_back(0);for(int i = 0;i<w.size();i++){if(node_in(nodes_covered,end[i])==0){nodes_covered.push_back(end[i]);cout<<start[i]<<"--"<<w[i]<<"-->"<<end[i]<<endl;}}return 0;}
